       ...
       <div className="max-w-7xl mx-auto relative z-10">
         ...
         <div className="mb-32 relative">
              <div className="flex items-center gap-4 mb-8 justify-center">
                 <span className="h-px w-12 bg-[#FFD700]"></span>
                 <h3 className="text-xl font-mono text-[#FFD700] uppercase tracking-[0.3em]">
                   Flagship Event
                 </h3>
                 <span className="h-px w-12 bg-[#FFD700]"></span>
              </div>
              ...
              >
                 ...
                 <div className="absolute inset-0 md:left-[30%] overflow-hidden">
                     ...
                     >
                          ...
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#FFD700]/10 rounded-full blur-[100px]"></div>
        ...
        {categories.filter(c => c.title !== "Flagship Event").map((category, catIndex) => (
          <div key={catIndex} className="mb-24 last:mb-0">
             <div className="flex items-center gap-4 mb-10">
                <span className="h-px flex-1 bg-linear-to-r from-transparent to-[#FFD700]/50"></span>
                <h3 className="text-xl md:text-2xl font-mono text-[#FFD700] uppercase trackingwidest">
                  {category.title}
                </h3>
                <span className="h-px flex-1 bg-linear-to-l from-transparent to-[#FFD700]/50"></span>
             </div>
            ...
            <div className="transform transition-transform duration-300 group-hover:-translate-y-2">
                <div className="flex gap-2 mb-4 flex-wrap">
                    {item.tags.map((tag: string, i: number) => (
                        <span key={i} className="text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-[#FFD700] border border-[#FFD700]/20">
                            {tag}
                        </span>
                    ))}
                </div>
