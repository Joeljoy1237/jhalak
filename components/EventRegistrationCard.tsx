    ...
    return (
        <motion.div 
            ...
            className={`relative border rounded-2xl overflow-hidden transition-all duration-300 ${
                isSelected 
                ? "bg-[#FFD700]/10 border-[#FFD700] shadow-[0_0_20px_rgba(255,215,0,0.15)]" 
                    ...
                    {isGroup && (isExpanded || isSelected) && !isLocked && (
                        ...
                        >
                            {isSelected ? (
                                // View Team State
                                <div>
                                    <h4 className="text-sm font-bold text-[#FFD700] mb-2">Your Team</h4>
                                    <ul className="space-y-2 mb-4">
                                        <li className="text-sm text-white flex items-center gap-2">
                                            <div className="w-6 h-6 rounded-full bg-[#FFD700] flex items-center justify-center text-black text-xs font-bold">L</div>
                                            You (Leader)
                                        </li>
                                ...
                                <div>
                                    ...
                                    <button 
                                        ...
                                        className="w-full py-2 bg-[#FFD700] text-black font-bold text-sm rounded-lg hover:bg-[#FFC000]"
                                    >
