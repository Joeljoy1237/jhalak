    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gradient-to-br from-[#FFD700]/20 to-black p-6 rounded-xl border border-white/10">
                    <h3 className="text-[#FFD700] text-xs font-bold uppercase tracking-widest mb-1">Total Participants</h3>
                    <p className="text-3xl font-black text-[#FFD700] font-unbounded">{totalParticipants}</p>
                </div>
            </div>
                    ...
                    <tbody className="divide-y divide-white/10 text-sm">
                        {filteredStats.map(stat => (
                            <tr key={stat.title} className="hover:bg-white/5 transition-colors group">
                                <td className="p-4">
                                    <div>
                                        <p className="font-bold text-white group-hover:text-[#FFD700] transition-colors">{stat.title}</p>
                                ...
                                <td className="p-4 text-right">
                                    <button 
                                        ...
                                        className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold border transition-colors ${
                                            ...
                                            : "border-white/20 text-white hover:bg-[#FFD700] hover:text-black hover:border-[#FFD700]"
                                        }`}
                                    >
